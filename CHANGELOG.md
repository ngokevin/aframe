...
- Added warning if component is statically registered after scene declaration. (#2310)
...
- Stability of WebVR browsers (Firefox Nightly and @tojiro's Chromium) in
  relation to SteamVR are in flux.
