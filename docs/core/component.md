...
This document details the API overview of a component. To see a guide on what
components are, what they look like, and how to write one, see the [Writing an
A-Frame Component guide][componentguide].
